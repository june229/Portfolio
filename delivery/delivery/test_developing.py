...
class OffboardControl(Node):
    ...
    def __init__(self):
        ...
        #--------------------------------------------------------------------------------
        self.waypoint1 = [28.216200000059644, -54.212400000006156, self.takeoff_altitude]
        self.waypoint2 = [91.8192000003728, -38.33940000005498, self.takeoff_altitude]
        #--------------------------------------------------------------------------------
    ...
    def laser_callback(self, msg):
        ...
        if 5.0 < front < 7.0:              #0.50 < front < 0.70:   5.0 < front < 7.0: 
            ...
            self.obstacle_closed = False
            self.status_dangered = False
        elif front < 3.5:                  #front < 0.35:         front < 3.5:  
    ...
    def cmdloop_callback(self):
        ...
        if self.nav_state == VehicleStatus.NAVIGATION_STATE_OFFBOARD:
            ...
            if not self.takeoff_complete:
                ...
                elif (22.5 < self.last_trajectory_msg.yaw / 0.01745667 <= 67.5) :
                    self.y_1 += self.b * (self.dt / 14.14) # -는 왼쪽, +는 오른쪽
                elif (67.5 < self.last_trajectory_msg.yaw / 0.01745667 <= 112.5) :
                    self.x_1 -= self.b * (self.dt / 10) #default 값 : 8
                    self.y_1 += self.b * (self.dt / 10) # -는 왼쪽, +는 오른쪽
                elif (112.5 < self.last_trajectory_msg.yaw / 0.01745667 <= 157.5) :
                    self.x_1 -= self.b * (self.dt / 14.14) #default 값 : 8
                elif (157.5 < self.last_trajectory_msg.yaw / 0.01745667 <= 202.5) :
                    self.x_1 -= self.b * (self.dt / 10) #default 값 : 8
                    self.y_1 -= self.b * (self.dt / 10) # -는 왼쪽, +는 오른쪽
                elif (202.5 < self.last_trajectory_msg.yaw / 0.01745667 <= 247.5) :
                    self.y_1 -= self.b * (self.dt / 14.14) # -는 왼쪽, +는 오른쪽
                elif (247.5 < self.last_trajectory_msg.yaw / 0.01745667 <= 292.5) :
                    self.x_1 += self.b * (self.dt / 10) #default 값 : 8
                    self.y_1 -= self.b * (self.dt / 10) # -는 왼쪽, +는 오른쪽
                elif (292.5 < self.last_trajectory_msg.yaw / 0.01745667 <= 337.5) :
                    self.x_1 += self.b * (self.dt / 14.14) #default 값 : 8
                    
                elif (-337.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -382.5) or (-697.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -742.5) or (-1057.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -1102.5):
                    self.x_1 += self.b * (self.dt / 10) #default 값 : 8
                    self.y_1 += self.b * (self.dt / 10) # -는 왼쪽, +는 오른쪽
                elif (-292.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -337.5) or (-652.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -697.5) or (-1012.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -1057.5):
                    self.y_1 += self.b * (self.dt / 14.14) # -는 왼쪽, +는 오른쪽
                elif (-247.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -292.5) or (-607.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -652.5) or (-967.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -1012.5):
                    self.x_1 -= self.b * (self.dt / 10) #default 값 : 8
                    self.y_1 += self.b * (self.dt / 10) # -는 왼쪽, +는 오른쪽
                elif (-202.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -247.5) or (-562.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -607.5) or (-922.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -967.5):
                    self.x_1 -= self.b * (self.dt / 14.14) #default 값 : 8
                elif (-157.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -202.5) or (-517.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -562.5) or (-877.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -922.5):
                    self.x_1 -= self.b * (self.dt / 10) #default 값 : 8
                    self.y_1 -= self.b * (self.dt / 10) # -는 왼쪽, +는 오른쪽
                elif (-112.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -157.5) or (-472.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -517.5) or (-832.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -877.5):
                    self.y_1 -= self.b * (self.dt / 14.14) # -는 왼쪽, +는 오른쪽
                elif (-67.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -112.5) or (-427.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -472.5) or (-787.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -832.5):
                    self.x_1 += self.b * (self.dt / 10) #default 값 : 8
                    self.y_1 -= self.b * (self.dt / 10) # -는 왼쪽, +는 오른쪽
                elif (-22.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -67.5) or (-382.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -427.5) or (-742.5 > self.last_trajectory_msg.yaw / 0.01745667 >= -787.5):
                    self.x_1 += self.b * (self.dt / 14.14) #default 값 : 8
            ...
            # 점진적 후진비행 및 장애물 회피
                ...
                aim_x=self.waypoint2[0] - self.x_1
                #값이 -이면 +, +이면 +를 한다.
                ...
                if aim_x > 0:
                    ...
                    if self.x_1 <= self.waypoint2[0]:
                        self.x_1 = self.waypoint2[0]
                aim_y=self.waypoint2[1] - self.y_1
                ...
                aim_x=self.x_1 - self.waypoint1[0]
                #복귀 위해 마이너스(-)
                self.x_1 -= aim_x / self.speed # 값이 커지면 속도가 느려진다.(5000)
                print(self.x_1)
                if aim_x > 0:
                    ...
                    if self.x_1 >= self.waypoint1[0]:
                        self.x_1 = self.waypoint1[0]
                aim_y=self.y_1 - self.waypoint1[1]
                self.y_1 -= aim_y / self.speed
                print(self.y_1)
                if aim_y > 0:
                    if self.y_1 <= self.waypoint1[1]:
                ...
                aim_x=self.x_1 - self.return_point[0]
                #값이 -이면 +, +이면 +를 한다.
                self.x_1 -= aim_x / self.speed # 값이 커지면 속도가 느려진다.(5000)
                print(self.x_1)
                if aim_x > 0:
                    ...
                    if self.x_1 >= self.return_point[0]:
                        self.x_1 = self.return_point[0]
                aim_y=self.y_1 - self.return_point[1]
                self.y_1 -= aim_y / self.speed
                print(self.y_1)
                if aim_y > 0:

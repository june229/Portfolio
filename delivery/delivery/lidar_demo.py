...
class OffboardControl(Node):
    ...
    def laser_callback(self, msg):
        ...
        if 5.0 < left_distances < 7.0:             #0.50 < front < 0.70:   5.0 < front < 7.0: 
        ...
        elif 4.0 < left_distances < 5.0:           #0.40 < front < 0.50:   4.0 < front < 5.0:   
            ...
            self.obstacle_detected2 = False
            self.obstacle_closed2 = False
        elif left_distances < 3.5:                 #front < 0.35:         front < 3.5:  
        ...
        if 5.0 < right_distances < 7.0:             #0.50 < front < 0.70:   5.0 < front < 7.0: 
            ...
            self.obstacle_detected1 = False
            self.obstacle_closed1 = False
        elif 4.0 < right_distances < 5.0:           #0.40 < front < 0.50:   4.0 < front < 5.0:   
            ...
            self.obstacle_detected1 = False
            self.obstacle_closed1 = False
        elif right_distances < 3.5:                 #front < 0.35:         front < 3.5:  
            ...
            self.obstacle_detected1 = False
            self.obstacle_closed1 = False
        elif 7.0 < right_distances or 3.5 < right_distances < 4.0:
            self.status_dangered2 = False
            self.obstacle_detected2 = False
            self.obstacle_closed2 = False
            self.status_dangered1 = False

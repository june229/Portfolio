    ...
    def cmdloop_callback(self):
        ...
        if self.nav_state == VehicleStatus.NAVIGATION_STATE_OFFBOARD:
            ...
            if not self.takeoff_complete:
                ...
                self.get_logger().info("Obstacle detected. Stopping drone movement.")
                trajectory_msg.position[0] = self.last_trajectory_msg.position[0]
                trajectory_msg.position[1] = self.last_trajectory_msg.position[1]

...
class OffboardControl(Node):
    ...
    def cmdloop_callback(self):
        ...
        offboard_msg.velocity = False #속도 제어
        offboard_msg.acceleration = False #가속도 제어
        self.publisher_offboard_mode.publish(offboard_msg)

        if self.nav_state == VehicleStatus.NAVIGATION_STATE_OFFBOARD:#오프보드 모드인지 확인
            ...
            if not self.takeoff_complete:
                ...
                trajectory_msg.yaw = 0.0  # Drone faces north
                ...
                trajectory_msg.position[1] = 0
                trajectory_msg.position[2] = self.takeoff_altitude
                trajectory_msg.yaw = 90.0  # Drone faces east
